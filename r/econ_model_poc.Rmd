...
#standardSQL
  ...
  SELECT
    ...
    from_anchorage_id events_from_anchorage_id,
    arrival_timestamp events_arrival_timestamp,
    to_anchorage_id events_to_anchorage_id,
  ...
  SELECT
    * EXCEPT(sum2_gear,
      ...
      events_from_anchorage_id,
      events_arrival_timestamp,
      events_to_anchorage_id),
  ...
  ON
    ...
    AND main_voyage2.from_anchorage_id = event_table.events_from_anchorage_id
    AND main_voyage2.arrival_timestamp = event_table.events_arrival_timestamp
    AND main_voyage2.to_anchorage_id = event_table.events_to_anchorage_id),
  penultimate2 AS(
  SELECT
    mmsi,
    gear,
